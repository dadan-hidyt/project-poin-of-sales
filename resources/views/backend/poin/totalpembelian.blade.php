                ...
                <div class="card-body">
                    <div class="form-informasi-reward">
                        <div class="d-flex align-items-center justify-content-between pb-5 border-1 border-bottom">
                            <span class="h3 fw-bolder">Tambah Poin Reward - Per Total Pembelian</span>
                        ...
                        <div class="form-group mb-5" style="margin-top : 30px;">
                            <section id="informasi" style="margin: 20px 0px;">
                                ...
                                <div class="my-5 d-flex">
                                    <label for="poinrewardname" class="form-label" style="width:20%;">Minumum Pembelian<span class="text-danger">*</span></label>
                                    <div class="d-flex flex-column" style="width:80%;" >
                                        <input type="text" class="form-control w-100" id="#" placeholder="Rp.10.000" >
