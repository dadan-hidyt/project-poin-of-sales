        ...
        <div class="card card-custom">
            <div class="card-header bg-primary">
                ...
                <div class="p-5">
                    ...
                    <a class="btn btn-success btn-sm" href="{{ route('dashboardkariawan.create') }}"><i
                    ...
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        <thead>
                            <tr class="text-left text-uppercase">
                                <th>NIK</th>
                                <th style="min-width: 250px" class="pl-7"><span class="text-dark-75">Kariawan</span></th>
                                ...
                                <tr>
                                    ...
                                    <td class="pl-0 py-8">
                                        <div class="d-flex align-items-center">
                                            ...
                                            @else
                                                <span class="symbol-label">
                                                    <img src="{{ asset($item->avatar) }}" width="100%" height="100%" class="h-75 align-self-end"
                                                        alt="">
                                                </span>
                                            @endempty
                                        </div>
                                        <div>
                                            ...
                                            <span class="text-muted font-weight-bold d-block">Jabatan: {{ $item->user->role ?? 'Belum Di definisikan' }}</span>
                                        </div>
                                    </div>
                                </td>
