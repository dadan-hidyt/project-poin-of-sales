...
<button type="button" class="col-md-3 p-0 " data-bs-toggle="modal" data-bs-target="#detailMeja-{{ $item->kode_pesanan }}">
    <div class="card">
        <div class="card-body">
...
<div class="modal fade" id="detailMeja-{{ $item->kode_pesanan }}" tabindex="-1" aria-labelledby="detailMejaLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-detailMeja">
        <div class="modal-content">
                ...
                <div class="container">
                    <div class="detail-meja d-flex  justify-content-between fs-6">
                        <ul>
                            ...
                            <li class="my-2">Pelanggan : <span>{{ $item->pelanggan->nama ?? 'Guest' }}</span> </li>
            ...
            <div class="modal-footer border-top py-4">
                <div class="container">
                    <a href="{{ route('kasir.pesanan.bayar',$item->kode_pesanan) }}" class="btn btn-primary p-1 px-2">Bayar Sekarang</a>
                    <a href="{{ route('kasir.pos',$item->kode_pesanan) }}" class="btn btn-primary p-1 px-2">Lihat</a>
                </div>
            </div>
        </div>
    </div>
