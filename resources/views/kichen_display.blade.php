                    ...
                    @if ($item->status_pesanan !== 'SELESAI')
                        <div class="col-md-3">
                            <div class="card rounded-0 shadow-sm">
                                <div class="card-head__kitchen d-flex align-items-center justify-content-between border-1 border-bottom p-4">
                                    <div>
                                ...
                                <div class="card-body">
                                    <ul class="detail-pesan_kitchen">
                                        @foreach ($item->detail_pesanan as $item2)
                                            <li class=" d-flex align-items-center justify-content-between border-bottom-grey mb-3">
                                                <div>
                                    ...
                                    <div class="footer_kitchen mt-4 d-flex align-items-center justify-content-between pt-4 border-1 border-top">
                                        <div class="btn-group w-100">
                                            @if ($item->status_pesanan == "DIPROSESS")    
                                                <a class="btn btn-secondary btn-prosess__kitchen w-100 "
                                                href="?pesanan={{ $item->id }}&status=dimasak">Prosess</a>
                                            @endif
                                            @if ($item->status_pesanan == "DIMASAK")    
                                                <a class="btn btn-success btn-done__kitchen w-100"
